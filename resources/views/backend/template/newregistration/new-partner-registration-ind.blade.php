                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-flex-item-box">
                                ...
                                <select name="partner_individual_employment_status" class="form-select" id="partner_individual_employment_status" aria-label="Default select example">
                        ...
                        <div class="col-lg-6">
                            <div class="form-flex-item-box">
                                ...
                                <select name="partner_individual_household_income" class="form-select" id="partner_individual_household_income" aria-label="Default select example">
                                    <option value="">Please Select</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-flex-item-box">
                                ...
                                <select name="partner_individual_employment_status_spouse" class="form-select" id="partner_individual_employment_status_spouse"  aria-label="Default select example">
                                    <option value="">Please Select</option>
                                    <option value="SE">Self Employed</option>
                                    <option value="W2">W2</option>
                                    <option value="HM">Home Maker</option> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-flex-item-box">
                                ...
                                <select name="partner_individual_state" class="form-select" id="partner_individual_state" data-select2-id="partner_individual_state_select" aria-label="Default select example">
