            ...
            <div class="form-wrapper">
                ...
                <div class="form-heading d-flex justify-content-between align-items-center">
                        <div class="col-lg-6">
                            <div class="form-flex-item-box order-error-select">
                                <label for="entity_select-list">Select Entity</label>
                                    <select name="ENTITY_SELECT" class="form-select select-matcher-obj select2" id="entity_filter_item"  data-select2-id="entity_select-list_select"  aria-label="Default select example">
                                    <optgroup label="Please Select Member" data-select2-id="entity_select-list_select">
                                        <option value="">Please Select</option>
                                        @foreach ( $users as $user ) 
                                            <option value="{{$user->ID}}">{{$user->ENTITY_NAME}}</option>
                        ...
                        <table id="expense_datatable" class="table table-striped table-bordered table-data-table">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>{{number_format($sum_total_share, 4) }}</th>
                                    <th>{{number_format($sum_total_shareholding, 4) }}%</th>
                                    <th>{{number_format($sum_total_cash, 4) }}</th>
                                    <th>{{number_format($sum_total_loan, 4) }}</th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
