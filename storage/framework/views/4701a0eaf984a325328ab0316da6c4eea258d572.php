                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-6">
                        <div class="form-flex-item-box">
                            ...
                            <input type="text" class="txtCal" name="CASH" id="CASH">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-flex-item-box">
                    ...
                    <div class="col-lg-6">
                        <div class="form-flex-item-box">
                            ...
                            <input type="text" class="txtCal" name="FINDER_FEES" id="FINDER_FEES">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-flex-item-box">
                            <label for="Closing Fees">Closing Fees</label>
                            <input type="text" class="txtCal" name="CLOSING_FEES" id="CLOSING_FEES">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-flex-item-box">
