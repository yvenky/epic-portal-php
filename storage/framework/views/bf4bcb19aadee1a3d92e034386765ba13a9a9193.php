                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-flex-item-box">
                                ...
                                <input type="text" class="form-control" name="STREET_1" value="<?php echo e($lists->address->STREET_1); ?>" id="partner_individual_street">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-flex-item-box">
                                <label for="partner_individual_city">City</label>
                                <input type="text" class="form-control" name="CITY" value="<?php echo e($lists->address->CITY); ?>" id="partner_individual_city">
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-flex-item-box">
                                ...
                                <input type="text" class="form-control"  name="ZIP_CODE" value="<?php echo e($lists->address->ZIP_CODE); ?>" id="partner_individual_zip_code">
                            </div>
                        </div>
                    </div>                
                </div>
