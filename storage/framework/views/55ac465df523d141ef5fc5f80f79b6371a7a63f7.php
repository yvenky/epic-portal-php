...
<section class="panel-wrapper panel-full-width mt-resp-top">
    ...
    <div class="form-wrapper p-0">
        <div class="form-heading d-flex justify-content-between align-items-center">
            <h6>Entity List</h6>
            <a href="<?php echo e(url('add-new-entry')); ?>" class="form-submit-btn">Add New</a>
        </div>
                ...
                <table id="expense_datatable" class="table table-striped table-bordered table-data-table">
                    ...
                    <tbody class="view-icon-table">
                      ...
                      <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($i++); ?></td>
                            <td><?php echo e($list->add_partner_entity_name); ?></td>
                            <td><?php echo e($list->add_partner_entity_ein); ?></td>
                            <td>
                                <a href="<?php echo e($list->add_partner_entity_docs); ?>" class="table-url-link">Entity Docs Link</a>
                            </td>    
                            <td>
